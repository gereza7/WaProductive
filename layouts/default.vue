<template>
  <v-app>
    <v-content >
        ...
        <!-- mobile -->
        <div class="d-block">
          <v-container fluid class="wa-topbar">
                ...
                <v-row no-gutters align="center" justify="center">
                  <nuxt-link to="/">
                    <v-row no-gutters align="center" justify="center">
                      <div class="logo">
   <v-img
  lazy-src="https://i.ibb.co/pzCFV65/waproductive-logo.png"
  src="https://i.ibb.co/pzCFV65/waproductive-logo.png"
></v-img>
                      </div>
          ...
          <v-navigation-drawer v-model="drawer" fixed left class="d-block">
              ...
              <v-container class="d-block menu-items">
                <div class="d-flex flex-column">
                  ...
                  <div class="d-flex">
                    <nuxt-link to="/">
                      <v-icon>mdi-view-dashboard-variant-outline</v-icon>&nbsp;&nbsp;<b>Kanban</b>
                    </nuxt-link>
                  </div>
                   <div class="d-flex">
                    <nuxt-link to="/chat">
