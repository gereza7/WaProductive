<template>
  <v-container>
        ...
        <v-form ref="form" v-model="valid">
          <div class="d-flex flex-column">
            <v-text-field
              ...
              name="title"
              type="text"
              :rules="[(v) => !!v || 'Se requiere un título']"
              required
              v-model="board.title"
            ></v-text-field>
    ...
    <div class="d-flex flex-row align-center justify-space-between">
      <h1>Secciones</h1>
      <v-btn small depressed @click="addBoard">Añadir sección</v-btn>
    </div>
    <div class="d-flex flex-wrap align-center justify-start">
      <p v-if="boards.length === 0">Sin secciones aún.</p>
      <v-card
...
export default {
  ...
  data() {
    return {
      ...
      snackbar: false,
      snackbarText: 'Sin mensaje de error',
      currentImageId: '',
      fileToUpload: {},
    }
  },
